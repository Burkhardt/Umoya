...
{
    public class ApiIntegrationTests : IClassFixture<UmoyaWebApplicationFactory>
    {
        private readonly WebApplicationFactory<Startup> _factory;
        private readonly HttpClient _client;

        public ApiIntegrationTests(UmoyaWebApplicationFactory factory, ITestOutputHelper output)
        {
