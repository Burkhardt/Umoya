...
namespace Umoya.Core.Indexing
{
    ...
    public class PackageIndexingService : IPackageIndexingService
    {
        ...
        private readonly IUmoyaSearchService _search;
        private readonly IOptionsSnapshot<UmoyaOptions> _options;
        private readonly ILogger<PackageIndexingService> _logger;

        public PackageIndexingService(
            IPackageService packages,
            IPackageStorageService storage,
            IUmoyaSearchService search,
            IOptionsSnapshot<UmoyaOptions> options,
