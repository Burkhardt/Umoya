...
namespace Umoya.Core
{
    ...
    public interface IPackageMetadataService
    {
        ...
        Task<UmoyaRegistrationIndexResponse> GetRegistrationIndexOrNullAsync(string packageId, CancellationToken cancellationToken = default);
        ...
        Task<UmoyaRegistrationLeafResponse> GetRegistrationLeafOrNullAsync(
            string packageId,
