...
namespace Umoya.Core
{
    public class RegistrationBuilder
    {
        ...
        public virtual UmoyaRegistrationIndexResponse BuildIndex(PackageRegistration registration)
        {
            ...
            return new UmoyaRegistrationIndexResponse
            {
        ...
        public virtual UmoyaRegistrationLeafResponse BuildLeaf(Package package)
        {
            var id = package.Id;
            var version = package.Version;

            return new UmoyaRegistrationLeafResponse
            {
        ...
        private RegistrationIndexPageItem ToRegistrationIndexPageItem(Package package) =>
            new RegistrationIndexPageItem
            {
                ...
                PackageMetadata = new UmoyaPackageMetadata
                {
