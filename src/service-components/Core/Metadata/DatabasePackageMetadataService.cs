...
namespace Umoya.Core.Metadata
{
    /// <inheritdoc />
    public class DatabasePackageMetadataService : IUmoyaPackageMetadataService
    {
        private readonly IMirrorService _mirror;
        private readonly IPackageService _packages;
        private readonly IUmoyaUrlGenerator _url;

        public DatabasePackageMetadataService(IMirrorService mirror, IPackageService packages, IUmoyaUrlGenerator url)
        {
