...
namespace Umoya.Core
{
    ...
    public class DefaultPackageMetadataService : IPackageMetadataService
    {
        ...
        public async Task<UmoyaRegistrationIndexResponse> GetRegistrationIndexOrNullAsync(
            string packageId,
        ...
        public async Task<UmoyaRegistrationLeafResponse> GetRegistrationLeafOrNullAsync(
            string id,
