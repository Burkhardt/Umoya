  ...
  private buildState(tab: Tab): IUploadState {
    ...
    switch (tab) {
      ...
      case Tab.PowerShellGet:
        name = "PowerShellGet";
        content = [
          `Register-PSRepository -Name "Umoya." -SourceLocation "${this.serviceIndexUrl}" -PublishLocation "${this.publishUrl}" -InstallationPolicy "Trusted"`,
          `Publish-Module -Name PS-Module -Repository Umoya.`
        ];
